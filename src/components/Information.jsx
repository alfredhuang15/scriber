...
export default function Information(props) {
  ...
  function handleDownload() {
    ...
    element.download = `Scriber_${new Date().toString()}.txt`
  ...
  return (
    <main className='flex-1 p-4 flex flex-col gap-3 sm:gap-4 justify-center text-center pb-20 mx-w-prose w-full mx-auto'>
      ...
      <div className='grid grid-cols-2 mx-auto bg-white border-2 border-solid border-blue-300 shadow rounded-full overflow-hidden items-center'>
      ...
      <div className='flex items-center gap-4 mx-auto'>
        <button onClick={handleCopy} title='copy' className='bg-white hover:text-blue-500 duration-200 text-blue-300 rounded px-2 aspect-square grid place-items-center'>
          <i className="fa-solid fa-copy"></i>
        </button>
        <button onClick={handleDownload} title='download' className='bg-white hover:text-blue-500 duration-200 text-blue-300 rounded px-2 aspect-square grid place-items-center'>
